...
export class HvacDuctingComponent implements OnInit {
  array2 = [{ product: 'Sheet Metal Air Ducts', img: '../../../assets/hvac-ducting/ducting-banner.jpg', desc: ' These are galvanized steel or aluminum made ducts and are the most common type of rigid air duct made of. These are the most durable type of air duct construction as it has got non-porous surface and are the least likely to have mold or any sort of biological growth.' },
